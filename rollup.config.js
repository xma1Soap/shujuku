...
const modules = [
  ...
  { path: 'src/presentation/window/window-styles.ts' },
  ...
  { path: 'src/presentation/pages/popup-bindings.ts' },
  { path: 'src/presentation/pages/popup-helpers.ts' },
  { path: 'src/presentation/pages/visualizer.ts' },
  { path: 'src/presentation/pages/visualizer-sidebar.ts' },
  { path: 'src/presentation/pages/visualizer-main.ts' },
